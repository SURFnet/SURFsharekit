<div>
    ...
    <p>
        Je verwijderverzoek is goedgekeurd. Je publicatie is verwijderd uit SURFsharekit.
    </p>
    ...
    <p>
        Your removal request has been approved. Your publication has been deleted from SURFsharekit.
    </p>
