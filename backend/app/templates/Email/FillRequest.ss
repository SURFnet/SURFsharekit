<div>
    ...
    <p>
        Er is een verzoek tot het aanvullen van een $PublicationType.nl voor $Institute waar jij $Role voor bent binnengekomen.
    ...
    <p>
        A request to add metadata to a $PublicationType.en for $Institute for which you are $Role has been made.
