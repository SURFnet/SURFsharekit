 ...
 * @property int BlueprintExportFileID
 * @method BlueprintExportFile BlueprintExportFile
 */
class BlueprintExportRequest extends DataObject {

    private static $table_name = "SurfSharekit_BlueprintExportRequest";
    private static $singular_name = "Blueprint export";
    private static $plural_name = "Blueprint exports";
    ...
    private static $has_one = [
        "BlueprintExportFile" => BlueprintExportFile::class
    ];
    ...
    public function getCMSFields() {
        ...
        if ($this->Status === "COMPLETED") {
            $downloadLink = $this->BlueprintExportFile()->getStreamURL();
