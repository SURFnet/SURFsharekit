...
class DisciplineMetaFieldProcessor extends ScopedMetaFieldProcessor
{
    private static $type = "Discipline";
    ...
    public function validate(): ApiValidationResult {
        ...
        $institutes = $discoverUploadService->getLevelBasedInstitutesUuids($instituteUuid, 'discipline');
