(function($) {
    $.entwine("ss", function($) {
        ...
        $(".hasoneautocomplete-search").entwine({
                ...
                var autocompleteOptions = {
                    ...
                    select: function(event, ui) {
                        ...
                        if (ui.item.currentString) {
                            t.getSearchFieldElement()[0].placeholder = ui.item.currentString;
                            // t.getSearchFieldElement().html(ui.item.currentString);
                        }
            ...
            getSearchFieldElement: function() {
                return this.closest('.hasoneautocomplete').find('.hasoneautocomplete-search').first();
            }
