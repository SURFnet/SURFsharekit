...
function ReactPublicationTable(props) {
    ...
    const columns = React.useMemo(
        () => [
            ...
            {
                Header: () => {
                    return [t('my_publications.table.title'), ' ',
            ...
            {
                Header: () => {
                    return [t('my_publications.table.organisation')]
                },
            ...
            {
                Header: () => {
                    return [t('my_publications.table.authors')]
                },
            ...
            {
                Header: () => {
                    return [t('my_publications.table.type'), ' ',
            ...
            {
                Header: () => {
                    return [t('my_publications.table.status'), ' ',
            ...
            {
                Header: () => {
                    return [t('my_publications.table.last_edited'), ' ',
