...
export function DoiField(props) {
    ...
    const [generatedDoi, setGeneratedDoi] = useState(null);
    ...
    return (
        <div className={"field-input-wrapper"}>
            ...
            {generatedDoi !== null && <div className={"field-input text readonly"}>{generatedDoi}</div>}
            {
                generatedDoi === null && <input type="text"
                                                key={'a'}
